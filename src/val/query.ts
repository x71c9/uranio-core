...
const urn_exc = urn_exception.init('QUERY_VALIDATE','schema.Query Validator');
 ...
 *
 */
function _validate_expression<A extends schema.AtomName>(field:schema.Query.Expression<A>, atom_name:A)
		:true{
 ...
 */
function validate_filter<A extends schema.AtomName>(query:schema.Query<A>, atom_name:A)
		:true{
 ...
 *
 */
function validate_options<A extends schema.AtomName, D extends schema.Depth>(options:schema.Query.Options<A,D>, atom_name:A)
		:true{
