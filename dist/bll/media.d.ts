...
export declare class MediaBLL extends BLL<'media'> {
    ...
    update_by_id(id: string, partial_atom: Partial<schema.AtomShape<'media'>>): Promise<schema.Atom<'media'>>;
    update_one(atom: schema.Atom<'media'>): Promise<schema.Atom<'media'>>;
