...
exports.create_autofix = exports.AutoFixDAL = void 0;
const urn_lib_1 = require("urn-lib");
const urn_atm = __importStar(require("../atm/"));
const trash_1 = require("./trash");
let AutoFixDAL = class AutoFixDAL extends trash_1.RecycleDAL {
...
AutoFixDAL = __decorate([
    urn_lib_1.urn_log.decorators.debug_constructor,
    urn_lib_1.urn_log.decorators.debug_methods
], AutoFixDAL);
exports.AutoFixDAL = AutoFixDAL;
// export type DalInstance = InstanceType<typeof DAL>;
function create_autofix(atom_name) {
    urn_lib_1.urn_log.fn_debug(`Create AutoFixDAL [${atom_name}]`);
    return new AutoFixDAL(atom_name);
}
exports.create_autofix = create_autofix;
