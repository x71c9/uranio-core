...
let DAL = class DAL {
    constructor(db_type, _atom_module) {
        this.db_type = db_type;
        this._atom_module = _atom_module;
        switch (this.db_type) {
            case 'mongo':
                this._db_relation = new urn_rels.mongo.MongooseRelation(this._atom_module.relation_name);
                this._db_trash_relation = new urn_rels.mongo.MongooseTrashRelation(this._atom_module.relation_name);
                break;
            default:
                this._db_relation = new urn_rels.mongo.MongooseRelation(this._atom_module.relation_name);
                this._db_trash_relation = new urn_rels.mongo.MongooseTrashRelation(this._atom_module.relation_name);
