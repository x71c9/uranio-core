 ...
 */
function validate_filter_options_params(atom_properties, filter, options) {
    validate_filter(filter, atom_properties);
    if (options) {
    ...
    switch (typeof field) {
        ...
        case 'object': {
            for (const k in field) {
                ...
                if (urn_lib_1.urn_util.object.has_key(_queryop.comparsion, k)) {
 ...
 */
function validate_filter(filter, atom_properties) {
    ...
    let key;
    for (key in filter) {
        if (urn_lib_1.urn_util.object.has_key(_queryop.andornor, key)) {
            ...
            if (!urn_lib_1.urn_util.object.has_key(atom_properties, key)) {
 ...
 *
 */
function validate_options(options, atom_properties) {
    if (urn_lib_1.urn_util.object.has_key(options, 'sort')) {
        switch (typeof options.sort) {
            case 'string': {
                ...
                if (!urn_lib_1.urn_util.object.has_key(atom_properties, sort_value)) {
            ...
            case 'object': {
                for (const k in options.sort) {
                    if (!urn_lib_1.urn_util.object.has_key(atom_properties, k)) {
