...
export declare class SelfishDAL<A extends AtomName> extends RecycleDAL<A> {
...
export declare function create_selfish<A extends AtomName>(atom_name: A): SelfishDAL<A>;
