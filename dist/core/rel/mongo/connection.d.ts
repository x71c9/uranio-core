...
declare class MongooseDBConnection {
     ...
     */
    constructor(con_name: ConnectionName, db_host: string, db_port: number, db_name: string);
    /**
     * Get a relation
     *
     * @returns a Relation
     */
    create_model<A extends AtomName>(relation_name: A, schema: mongoose.Schema): mongoose.Model<mongoose.Document>;
    /**
...
export declare function create(con_name: ConnectionName, db_host: string, db_port: number, db_name: string): ConnectionInstance;
export {};
